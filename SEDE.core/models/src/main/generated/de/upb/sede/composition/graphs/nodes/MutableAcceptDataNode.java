...
public final class MutableAcceptDataNode implements IAcceptDataNode {
  ...
  public final String getNodeType() {
    return nodeTypeIsSet()
        ? nodeType
        : IAcceptDataNode.super.getNodeType();
  }
  ...
  /**
   * Assigns a value to the {@link IAcceptDataNode#getNodeType() nodeType} attribute.
   * <p><em>If not set, this attribute will have a default value returned by the initializer of {@link IAcceptDataNode#getNodeType() nodeType}.</em>
   * @param nodeType The value for nodeType
   * @return {@code this} for use in a chained invocation
   */
  @CanIgnoreReturnValue
  public MutableAcceptDataNode setNodeType(String nodeType) {
  ...
  /**
   * Returns {@code true} if the default attribute {@link IAcceptDataNode#getNodeType() nodeType} is set.
   * @return {@code true} if set
   */
