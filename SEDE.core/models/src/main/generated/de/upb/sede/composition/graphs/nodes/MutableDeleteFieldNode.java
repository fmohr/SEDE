...
public final class MutableDeleteFieldNode implements IDeleteFieldNode {
  ...
  public final String getNodeType() {
    return nodeTypeIsSet()
        ? nodeType
        : IDeleteFieldNode.super.getNodeType();
  }
  ...
  /**
   * Assigns a value to the {@link IDeleteFieldNode#getNodeType() nodeType} attribute.
   * <p><em>If not set, this attribute will have a default value returned by the initializer of {@link IDeleteFieldNode#getNodeType() nodeType}.</em>
   * @param nodeType The value for nodeType
   * @return {@code this} for use in a chained invocation
   */
  @CanIgnoreReturnValue
  public MutableDeleteFieldNode setNodeType(String nodeType) {
  ...
  /**
   * Returns {@code true} if the default attribute {@link IDeleteFieldNode#getNodeType() nodeType} is set.
   * @return {@code true} if set
   */
  ...
  private boolean equalTo(MutableDeleteFieldNode another) {
    ...
    return nodeType.equals(another.getNodeType())
