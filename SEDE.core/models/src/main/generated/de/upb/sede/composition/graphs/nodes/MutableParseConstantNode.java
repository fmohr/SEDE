...
public final class MutableParseConstantNode implements IParseConstantNode {
  ...
  public final String getNodeType() {
    return nodeTypeIsSet()
        ? nodeType
        : IParseConstantNode.super.getNodeType();
  }
  ...
  /**
   * Fill this modifiable instance with attribute values from the provided {@link de.upb.sede.composition.graphs.nodes.IParseConstantNode} instance.
   * @param instance The instance from which to copy values
   * @return {@code this} for use in a chained invocation
   */
  @CanIgnoreReturnValue
  ...
  private void from(Object object) {
    if (object instanceof MutableParseConstantNode) {
      MutableParseConstantNode instance = (MutableParseConstantNode) object;
  ...
  /**
   * Assigns a value to the {@link IParseConstantNode#getNodeType() nodeType} attribute.
   * <p><em>If not set, this attribute will have a default value returned by the initializer of {@link IParseConstantNode#getNodeType() nodeType}.</em>
   * @param nodeType The value for nodeType
   * @return {@code this} for use in a chained invocation
   */
  @CanIgnoreReturnValue
  public MutableParseConstantNode setNodeType(String nodeType) {
  ...
  /**
   * Returns {@code true} if the default attribute {@link IParseConstantNode#getNodeType() nodeType} is set.
   * @return {@code true} if set
   */
