...
public final class CastTypeNode implements ICastTypeNode {
  ...
  public final CastTypeNode withSourceType(String value) {
    ...
    return new CastTypeNode(newValue, this.targetType, this.castToSemantic, this.casterClasspath, this.fieldName);
  }
  ...
  public final CastTypeNode withTargetType(String value) {
    ...
    return new CastTypeNode(this.sourceType, newValue, this.castToSemantic, this.casterClasspath, this.fieldName);
  }
  ...
  public final CastTypeNode withCastToSemantic(boolean value) {
    ...
    return new CastTypeNode(this.sourceType, this.targetType, value, this.casterClasspath, this.fieldName);
  }
  ...
  public final CastTypeNode withCasterClasspath(String value) {
    ...
    return new CastTypeNode(this.sourceType, this.targetType, this.castToSemantic, newValue, this.fieldName);
  }
  ...
  public final CastTypeNode withFieldName(String value) {
    ...
    return new CastTypeNode(this.sourceType, this.targetType, this.castToSemantic, this.casterClasspath, newValue);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code sourceType}, {@code targetType}, {@code castToSemantic}, {@code casterClasspath}, {@code fieldName}.
   ...
   * {@inheritDoc}
   * <p>
   * Returns a lazily initialized value of the {@link ICastTypeNode#getNodeType() nodeType} attribute.
  ...
  public String getNodeType() {
    if ((lazyInitBitmap & NODE_TYPE_LAZY_INIT_BIT) == 0) {
      synchronized (this) {
        if ((lazyInitBitmap & NODE_TYPE_LAZY_INIT_BIT) == 0) {
          this.nodeType = Objects.requireNonNull(ICastTypeNode.super.getNodeType(), "nodeType");
  ...
  public static final class Builder {
    ...
    public CastTypeNode build() {
      ...
      return new CastTypeNode(sourceType, targetType, castToSemantic, casterClasspath, fieldName);
    }
