...
public final class FinishNode implements IFinishNode {
  ...
  private FinishNode(IExecutorContactInfo clientContactInfo, String fieldName) {
  ...
  public final FinishNode withClientContactInfo(IExecutorContactInfo value) {
    ...
    return new FinishNode(newValue, this.fieldName);
  }
  ...
  public final FinishNode withFieldName(String value) {
    ...
    return new FinishNode(this.clientContactInfo, newValue);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code clientContactInfo}, {@code fieldName}.
   ...
   * {@inheritDoc}
   * <p>
   * Returns a lazily initialized value of the {@link IFinishNode#getNodeType() nodeType} attribute.
  ...
  public String getNodeType() {
    if ((lazyInitBitmap & NODE_TYPE_LAZY_INIT_BIT) == 0) {
      synchronized (this) {
        if ((lazyInitBitmap & NODE_TYPE_LAZY_INIT_BIT) == 0) {
          this.nodeType = Objects.requireNonNull(IFinishNode.super.getNodeType(), "nodeType");
  ...
  public static final class Builder {
    ...
    public FinishNode build() {
      ...
      return new FinishNode(clientContactInfo, fieldName);
    }
