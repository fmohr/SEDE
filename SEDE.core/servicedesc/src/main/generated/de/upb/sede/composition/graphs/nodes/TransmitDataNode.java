...
public final class TransmitDataNode implements ITransmitDataNode {
  ...
  public final TransmitDataNode withContactInfo(IExecutorContactInfo value) {
    ...
    return new TransmitDataNode(newValue, this.caster, this.semantiveType, this.fieldName);
  }
  ...
  public final TransmitDataNode withCaster(@Nullable String value) {
    ...
    return new TransmitDataNode(this.contactInfo, value, this.semantiveType, this.fieldName);
  }
  ...
  public final TransmitDataNode withSemantiveType(@Nullable String value) {
    ...
    return new TransmitDataNode(this.contactInfo, this.caster, value, this.fieldName);
  }
  ...
  public final TransmitDataNode withFieldName(String value) {
    ...
    return new TransmitDataNode(this.contactInfo, this.caster, this.semantiveType, newValue);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code contactInfo}, {@code caster}, {@code semantiveType}, {@code fieldName}.
   ...
   * {@inheritDoc}
   * <p>
   * Returns a lazily initialized value of the {@link ITransmitDataNode#getNodeType() nodeType} attribute.
  ...
  public String getNodeType() {
    if ((lazyInitBitmap & NODE_TYPE_LAZY_INIT_BIT) == 0) {
      synchronized (this) {
        if ((lazyInitBitmap & NODE_TYPE_LAZY_INIT_BIT) == 0) {
          this.nodeType = Objects.requireNonNull(ITransmitDataNode.super.getNodeType(), "nodeType");
  ...
  public static final class Builder {
    ...
    public TransmitDataNode build() {
      ...
      return new TransmitDataNode(contactInfo, caster, semantiveType, fieldName);
    }
