...
public class FilteredIteratorTest {
	...
	public void testFilteredIterator() {
		...
		try {
			new FilteredIterator<>(null, condition1); // passing null as the base iterator will throw a nulltpointer
														// exception
	...
	/**
	 * helper function that asserts that the values returned by the given filtered
