 ...
 */
public class ProcessOutputStreamWorker implements StreamWorker {
    ...
    private ProcessStreamRunner standardOutputReader;
    private ProcessStreamRunner standardErrorReader;

    public ProcessOutputStreamWorker(OutputStream standardOutput, OutputStream errorOutput, boolean readErrorStream) {
    ...
    public void connectStreams(Process process, String processName, Executor executor) {
        ...
        standardOutputReader = new ProcessStreamRunner("read standard output of " + processName, process.getInputStream(), standardOutput, completed);
        if (readErrorStream) {
            standardErrorReader = new ProcessStreamRunner("read error output of " + processName, process.getErrorStream(), errorOutput, completed);
        }
    }
