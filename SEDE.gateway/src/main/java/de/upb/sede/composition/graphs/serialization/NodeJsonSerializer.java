...
public final class NodeJsonSerializer {
	...
	public JSONObject InstructionNodeToJSON(InstructionNode instructionNode) {
		...
		jsonObject.put("output-index", instructionNode.getOutputIndex());
		return jsonObject;
	}
	...
	public InstructionNode InstructionNodeFromJSON(Map<Object, Object> node) {
		...
		Number outputIndex =  ((Number) node.get("output-index"));
		...
		if(outputIndex != null) {
			instructionNode.setOutputIndex(outputIndex.intValue());
		}
