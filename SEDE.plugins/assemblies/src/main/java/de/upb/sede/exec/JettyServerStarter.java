...
public class JettyServerStarter {
	...
	private final static Logger logger = LoggerFactory.getLogger(JettyServerStarter.class);
	...
	public static void main(String[] args) {
		...
		ExecutorJettyServer httpExecutor = new ExecutorJettyServer(executorConfiguration, serverHostAddress, serverPort);
