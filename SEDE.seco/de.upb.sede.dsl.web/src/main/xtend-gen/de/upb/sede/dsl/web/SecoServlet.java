...
import de.upb.sede.dsl.web.SecoWebSetup;
...
public class SecoServlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new SecoWebSetup().createInjectorAndDoEMFRegistration();
