...
public class Yield extends MinimalEObjectImpl.Container implements EObject {
	/**
	 * The cached value of the '{@link #getYields() <em>Yields</em>}' containment
	...
	/**
	 * The default value of the '{@link #isMultiYield() <em>Multi Yield</em>}'
	...
	/**
	 * The cached value of the '{@link #isMultiYield() <em>Multi Yield</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isMultiYield()
	 * @generated
