...
public class SecoSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SecoPackage.ENTITY_DEPLOYMENT_DEFINITION: {
			EntityDeploymentDefinition entityDeploymentDefinition = (EntityDeploymentDefinition) theEObject;
			T result = caseEntityDeploymentDefinition(entityDeploymentDefinition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SecoPackage.DEPLOYMENT_PROCEDURE: {
			DeploymentProcedure deploymentProcedure = (DeploymentProcedure) theEObject;
			T result = caseDeploymentProcedure(deploymentProcedure);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SecoPackage.DEPLOYMENT_DEPENDENCY: {
			DeploymentDependency deploymentDependency = (DeploymentDependency) theEObject;
			T result = caseDeploymentDependency(deploymentDependency);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Entity
	 * Deployment Definition</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Entity
	 *         Deployment Definition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEntityDeploymentDefinition(EntityDeploymentDefinition object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of
	 * '<em>Deployment Procedure</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of
	 *         '<em>Deployment Procedure</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDeploymentProcedure(DeploymentProcedure object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of
	 * '<em>Deployment Dependency</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of
	 *         '<em>Deployment Dependency</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
