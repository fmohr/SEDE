...
/**
 * A sample validator interface for {@link de.upb.sede.dsl.seco.Assignment}.
...
public interface AssignmentValidator {
	...
	boolean validateAssignedFields(EList<Field> value);

	boolean validateAssignedFields(List<Field> value);

	boolean validateMultiAssignment(boolean value);
