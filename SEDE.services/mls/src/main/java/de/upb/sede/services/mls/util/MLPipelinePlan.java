...
public class MLPipelinePlan implements Serializable {
	...
	/** these aren't necessary anymore. safely remove them later. */
	public static String hostJASE = "something";
	public static String hostPASE = "to not be null";
	...
	public MLPipe addAttributeSelection(final String classname) {
		MLPipe asPipe = new MLPipe(hostJASE, Objects.requireNonNull(classname));
	...
	public MLPipe setClassifier(final String classifierName) {
		...
		Objects.requireNonNull(hostJASE, "Host needs to be specified before adding pipes to the pipeline.");
		this.cPipe = new MLPipe(hostJASE, classifierName); // set cPipe field.
		return this.cPipe;
	}
