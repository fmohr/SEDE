 ...
 * @author aminfaez
 * 
 * Exception used in case of a syntax-error in fmCompositions.
 * (Extends RuntimeException because checked exceptions are bad!)
 */
public class FMCompositionSyntaxException extends RuntimeException {
	...
	public FMCompositionSyntaxException(String text, String regex){
		super(String.format("Parse error in:\n\t{}\nwith regex:\n\t{}. Visit https://www.freeformatter.com/java-regex-tester.html to debug the regex if necessary.", text, regex));	
	}
