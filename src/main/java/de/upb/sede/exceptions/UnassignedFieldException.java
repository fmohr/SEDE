 ...
 * unassigned field of data objects.
 */
public class UnassignedFieldException extends RuntimeException {
	...
	/**
	 * Constructor that sets the message field of exception. The message is created
	 * using dataobject.getClass().getSimpleName() and fieldname.
	 */
	public UnassignedFieldException(Object dataobject, String fieldname) {
		super(String.format("Accessed unassigned field:%s of an instance of class%s.", fieldname,
